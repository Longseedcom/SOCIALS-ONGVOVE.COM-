...
export const ZaloIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M109.133 56.4286H143.511L90.8669 143.571H56.4887L109.133 56.4286Z" fill="white"/>
    <path d="M127.756 100.952C127.756 116.142 115.659 128.381 100.222 128.381C84.785 128.381 72.6887 116.142 72.6887 100.952C72.6887 85.7617 84.785 73.5238 100.222 73.5238C115.659 73.5238 127.756 85.7617 127.756 100.952Z" fill="white"/>
  </svg>
);
